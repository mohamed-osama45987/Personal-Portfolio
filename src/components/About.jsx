...
function About() {
  return (
    <section
      id="About"
      className="container mx-auto flex flex-col lg:flex-row p-5 md:p-8 gap-16 min-h-screen"
    >
      <div className="w-full lg:w-1/2">
        <h4 className="text-2xl md:text-3xl text-headerColor mb-7 md:mb-14 font-semibold">
          01.About me
        </h4>
        <p className="md:text-xl	text-textColor mb-4 md:mb-8">
        ...
        <p className="md:text-xl	text-textColor">
        ...
        <h2 className="md:text-xl mb-3 md:mb-6  mt-8 md:mt-16 text-textColor">
      ...
      <div className="lg:w-1/2 items-start content-center lg:mt-20 xl:mt-0">
        <img
